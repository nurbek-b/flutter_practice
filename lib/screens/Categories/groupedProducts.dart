...
class ListByGroup extends StatefulWidget {
  final List<Product> items;
  final String title;

  ListByGroup({this.items, this.title});

  @override
  _ListByGroupState createState() => _ListByGroupState();
}

class _ListByGroupState extends State<ListByGroup> {
  @override
